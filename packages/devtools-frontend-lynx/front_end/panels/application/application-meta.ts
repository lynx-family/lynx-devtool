...
// The legacy Application panel registrations below intentionally remain commented out so they can be restored later.
...
UI.ViewManager.registerViewExtension({
  ...
  async loadView() {
    ...
    // Legacy Application panel entry retained for future restoration:
    // return Resources.ResourcesPanel.ResourcesPanel.instance();
    return Resources.LynxApplication.LynxApplication.instance();
  },
